...
HELLO_ASSISTANT = "hello Jarvis"
ASSISTANT_OFF = "Jarvis turn off"
ASSISTANT_COMMANDS_PREFIX = "Jarvis "
...
if __name__ == "__main__":
    ...
    speak_Polish("dziękuje bardzo że pytasz :-) ")

    speak_Polish("emotikonek ;-)  :-D ")
